        ...
        <div class="content-wrapper">
            <div class="container-fluid">
                <div class="row">
                    ...
                    <div class="col-12">
                        <h3 class="h3 text-center heading-2 text-primary py-2 mb-1 rounded">Edit Attendance</h3>
                    </div>
                    <div class="col-11 my-2 attendance-div border mx-auto border-primary rounded shadow px-5 pt-4 bg-light">
                        <form action="" method="POST">
                            <div class="form-group input-group">
                                ...
                                <select name="class" class="custom-select" required disabled>
                            ...
                            <div class="form-group input-group">
                                ...
                                <input type="date" name="attendance-date" class="form-control" value="<?php echo $date;?>" disabled required>
                            </div>
                            <div class="form-group input-group">
                                <div class="input-group-append">
                                    <span class="input-group-text">
                                ...
                                <select name="subject" class="custom-select" disabled required>
                                    <option value="<?php echo $row['SubjectId'] ?>"><?php echo $row['SubjectName'] . " ( " . $row['SubjectCode'] . " )"; ?></option>
                                </select>
                            </div>
                                            ...
                                            if($row[5])
                                                echo "<td>
                                                        <div class='form-check form-check-inline'>
                                                            <input type='radio' class='form-check-input' name='attendance[$row[1]]' value='0'>
                                                            <label class='form-check-label mr-2 text-danger'>Absent</label>
                                                            <input type='radio' class='form-check-input' name='attendance[$row[1]]' value='1' checked>
                                                ...
                                                echo "<td>
                                                        <div class='form-check form-check-inline'>
                                                            <input type='radio' class='form-check-input' name='attendance[$row[1]]' value='0' checked>
                                                            <label class='form-check-label mr-2 text-danger'>Absent</label>
                                                            <input type='radio' class='form-check-input' name='attendance[$row[1]]' value='1'>
                                                            <label class='form-check-label text-success'>Present</label>
                                                        </div>
                                                    </td>";
                            ...
                            <div class="form-group text-center mt-5 mb-3">
                                <input type="submit" value="Update Attendance" class="btn btn-primary my-2" name="update">
                            </div>
                        </form>
                    </div>
                </div> <!--row-->
...
<?php
    ...
    if(isset($_POST['update']))
    {
        ...
        {
            $query = "UPDATE attendance SET Attendance='$value' WHERE StudentId='$key' AND SubjectId='$sid' AND AttendanceDate='$date'";
            $result = mysqli_query($conn, $query);
        }

        if($result)
        {
            echo "<script>document.location = 'manage-attendance.php?T=success&NM=Attendance Updated Successfully';</script>";
        }
        else
